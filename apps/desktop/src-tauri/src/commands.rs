...
use crate::{
    models::{
        Conversation, SendMessageRequest, CreateProjectRequest, UpdateProjectRequest,
        Agent, CreateAgentRequest, UpdateAgentRequest, AgentWorkHistory, AgentPerformanceMetrics
    },
...
pub async fn update_agent(
    ...
    // 获取现有智能体
    let existing_agent = agent_repo.find_by_id(agent_uuid).await
        .map_err(|e| format!("查询智能体失败: {}", e))?
